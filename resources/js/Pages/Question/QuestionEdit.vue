        ...
        <Master>
            <div class="mb-4 border-0 card"  style="border-radius: 15px;">
                <div class="bg-transparent card-header">
                    <h5 class="py-2 mb-0">Edit Question</h5>
                </div>
                <div class="card-body">
                    <form @submit.prevent="updateQuestion(question.slug)">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea v-model="description" name="" class="form-control" :class="[ errors.description ? 'border border-danger' : '' ]" id=""  rows="" style="border-radius: 15px; min-height: 30vh"></textarea>
                        ...
                        <button class="mt-3 btn btn-primary float-end" :disabled="loading">
                            ...
                            <span v-show="!loading">Update Question</span>
                        </button>
                    </form>
                </div>
            </div>
        ...
        methods: {
            loadQuestion () {
                ...
                for(let i=0; i < this.question.tag.length ; i++){
                    this.tags[i] = this.question.tag[i].id;
                }
            },
            updateQuestion(slug){
                this.loading = true;
                ...
                this.$inertia.post(this.route('question.update',slug),data,{
