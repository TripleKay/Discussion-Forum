<template>
    <div>
        ...
        <div v-show="isProfileUrl == true" class="card border-0 mb-3" style="border-radius: 15px;">
            ...
            <div class="card-body">
                <div class="">
                    <Link :href="route('profile.edit')" class="btn w-100 text-start mb-2" style="border: .5px solid #00000010; border-radius: 15px;"><i class="fas fa-user-edit me-2"></i>Edit Profile</Link>
        ...
        <div class="card border-0 mb-3" style="border-radius: 15px;">
            <div class="card-body">
                <div class="">
                    <Link href="/?type=answered" class="btn w-100 text-start mb-2" style="border: .5px solid #00000010; border-radius: 15px;">Answered Questions</Link>
                    <Link href="/?type=unanswered" class="btn w-100 text-start mb-2" style="border: .5px solid #00000010; border-radius: 15px;">UnAnswered Questions</Link>
                </div>
            </div>
        </div>
    </div>
